...
class CourseOfferingsControllerTest < ActionController::TestCase
  ...
  test "should create course_offering" do
    assert_difference('CourseOffering.count') do
      post :create, course_offering: { course_id: @course_offering.course_id, quarter: @course_offering.quarter, url: @course_offering.url, year: @course_offering.year }
    end
  ...
  test "should update course_offering" do
    patch :update, id: @course_offering, course_offering: { course_id: @course_offering.course_id, quarter: @course_offering.quarter, url: @course_offering.url, year: @course_offering.year }
    assert_redirected_to course_offering_path(assigns(:course_offering))
  end
