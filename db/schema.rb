...
ActiveRecord::Schema.define(version: 20140826050528) do
  ...
  create_table "document_person_maps", force: true do |t|
  ...
  create_table "documents_grants", id: false, force: true do |t|
  ...
  create_table "documents_research_areas", id: false, force: true do |t|
    t.integer "document_id"
  ...
  create_table "grants_people", id: false, force: true do |t|
    t.integer "grant_id"
    t.integer "person_id"
  end

  create_table "grants_products", id: false, force: true do |t|
    t.integer "grant_id"
    t.integer "product_id"
  end

  create_table "grants_projects", id: false, force: true do |t|
    t.integer "grant_id"
    t.integer "project_id"
  end
  ...
  create_table "people_research_areas", id: false, force: true do |t|
    t.integer "person_id"
    t.integer "research_area_id"
  end
  ...
  create_table "product_person_maps", force: true do |t|
  ...
  create_table "products_projects", id: false, force: true do |t|
    t.integer "product_id"
    t.integer "project_id"
  end

  create_table "products_research_areas", id: false, force: true do |t|
    t.integer "product_id"
    t.integer "research_area_id"
  end
  ...
  create_table "projects_research_areas", id: false, force: true do |t|
    t.integer "project_id"
    t.integer "research_area_id"
  end
